...
require_once(DIR_LIBRARY . 'trading/EbatNs_Session.php');
require_once(DIR_LIBRARY . 'trading/EbatNs_ServiceProxy.php');
require_once(DIR_LIBRARY . 'trading/EbatNs_DataConverter.php');
require_once(DIR_LIBRARY . 'trading/GetMyeBaySellingRequestType.php');
require_once(DIR_LIBRARY . 'trading/GetOrdersRequestType.php');
